...
public class UpdateProfileCommandValidatorTests
{
    ...
    private UpdateProfileCommand _command;
    ...
    public UpdateProfileCommandValidatorTests()
    {
        ...
        _command = new UpdateProfileCommand(1, "John", "Doe", DateTime.Now.AddMonths(-10), "Description", "PictureUrl", "test role");
    }

    [Fact]
    public void UpdateProfileCommandValidator_WithInvalidUserId_ReturnsFalse()
    {
        // Arrange
    ...
    [Fact]
    public void UpdateProfileCommandValidator_WithValidUserId_ReturnsTrue()
    {
        // Arrange
    ...
    public void UpdateProfileCommandValidator_WithInvalidFirstName_ReturnsFalse(string firstName)
    {
        // Arrange
    ...
    [Fact]
    public void UpdateProfileCommandValidator_WithValidFirstName_ReturnsTrue()
    {
        // Arrange
    ...
    [Theory]
    [InlineData(longString)]
    public void UpdateProfileCommandValidator_WithInvalidLastName_ReturnsFalse(string lastName)
    {
        // Arrange
    ...
    [Fact]
    public void UpdateProfileCommandValidator_WithValidLastName_ReturnsTrue()
    {
        // Arrange
    ...
    [Fact]
    public void UpdateProfileCommandValidator_WithInvalidBirthDate_ReturnsFalse()
    {
        // Arrange
    ...
    [Fact]
    public void UpdateProfileCommandValidator_WithValidBirthDate_ReturnsTrue()
    {
        // Arrange
        _command.BirthDate = DateTime.Now.AddMonths(-10);
    ...
    [Fact]
    public void UpdateProfileCommandValidator_WithInvalidDescription_ReturnsFalse()
    {
        // Arrange
    ...
    public void UpdateProfileCommandValidator_WithValidDescription_ReturnsTrue(string description)
    {
        // Arrange
    ...
    [InlineData("")]
    [InlineData(longString)]
    public void UpdateProfileCommandValidator_WithInvalidCurrentRole_ReturnsFalse(string currentRole)
    {
        // Arrange
    ...
    [Fact]
    public void UpdateProfileCommandValidator_WithValidCurrentRole_ReturnsTrue()
    {
        // Arrange
