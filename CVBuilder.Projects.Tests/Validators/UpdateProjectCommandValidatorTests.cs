...
public class UpdateProjectCommandValidatorTests
{
    ...
    private UpdateProjectCommand _command;
    ...
    public UpdateProjectCommandValidatorTests()
    {
        ...
        _command = new UpdateProjectCommand(1, "Project Title", "Customer", DateTime.Now.AddMonths(-10), DateTime.Now.AddMonths(-5), "Description", "PictureUrl");
    }

    [Fact]
    public void UpdateProjectCommandValidator_WithInvalidProjectId_ReturnsFalse()
    {
        // Arrange
    ...
    [Fact]
    public void UpdateProjectCommandValidator_WithValidProjectId_ReturnsTrue()
    {
        // Arrange
    ...
    public void UpdateProjectCommandValidator_WithInvalidTitle_ReturnsFalse(string title)
    {
        // Arrange
    ...
    [Fact]
    public void UpdateProjectCommandValidator_WithValidTitle_ReturnsTrue()
    {
        // Arrange
    ...
    [InlineData("")]
    [InlineData(longString)]
    public void UpdateProjectCommandValidator_WithInvalidCustomer_ReturnsFalse(string customer)
    {
        // Arrange
    ...
    [Fact]
    public void UpdateProjectCommandValidator_WithValidCustomer_ReturnsTrue()
    {
        // Arrange
        _command.Customer = "Customer";
    ...
    [InlineData(-1)]
    [InlineData(2)]
    public void UpdateProjectCommandValidator_WithInvalidStartDate_ReturnsFalse(int months)
    {
        // Arrange
    ...
    [Fact]
    public void UpdateProjectCommandValidator_WithValidStartDate_ReturnsTrue()
    {
        // Arrange
    ...
    [InlineData(-6)]
    [InlineData(2)]
    public void UpdateProjectCommandValidator_WithInvalidEndDate_ReturnsFalse(int months)
    {
        // Arrange
    ...
    [Fact]
    public void UpdateProjectCommandValidator_WithValidEndDate_ReturnsTrue()
    {
        // Arrange
        _command.EndDate = DateTime.Now.AddMonths(-5);
    ...
    [Fact]
    public void UpdateProjectCommandValidator_WithInvalidDescription_ReturnsFalse()
    {
        // Arrange
    ...
    [Fact]
    public void UpdateProjectCommandValidator_WithValidDescription_ReturnsTrue()
    {
        // Arrange
